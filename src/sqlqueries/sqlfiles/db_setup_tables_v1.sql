...
CREATE TABLE IF NOT EXISTS `DEMOWMS`.`LAGERBEREICH` (
  ...
  `LOGISTIKZENTRUM_P_OID` INT NOT NULL,
  PRIMARY KEY (`P_OID`),
...
CREATE TABLE IF NOT EXISTS `DEMOWMS`.`LOADING_AREA` (
  ...
  `P_BREITE` FLOAT NULL,
  `P_LAENGE` FLOAT NULL,
  `LAGERBEREICH_P_OID` INT NOT NULL,
  PRIMARY KEY (`P_OID`),
...
CREATE TABLE IF NOT EXISTS `DEMOWMS`.`FAHRZEUG` (
  ...
  `LOGISTIKZENTRUM_P_OID` INT NOT NULL,
  `FAHRZEUGTYP_P_OID` INT NOT NULL,
  PRIMARY KEY (`P_OID`),
...
CREATE TABLE IF NOT EXISTS `DEMOWMS`.`LAGERHILFSMITTEL` (
  ...
  INDEX `fk_LAGERHILFSMITTEL_LHMTYPZUORDUNG1_idx` (`LHMTYPZUORDUNG_P_OID` ASC),
  ...
  CONSTRAINT `fk_LAGERHILFSMITTEL_TRANSPORTAUFTRAG1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_LAGERHILFSMITTEL_LHMTYPZUORDUNG1`
